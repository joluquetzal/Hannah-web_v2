# Coding rules — HannaH web

Conventions for this project, split by topic. These expand on the "Coding conventions" section of the root `CLAUDE.md`; where they conflict, `CLAUDE.md` wins.
...
| `accessibility-seo.md` | Landmarks, headings, contrast, metadata, JSON-LD |
| `content-i18n.md` | Spanish UI / English code, `data/` as source of truth, es-MX formatting |
| `project-workflow.md` | Folder layout, pre-commit checks, commits, deps, perf budget |
